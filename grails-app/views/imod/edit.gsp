...
.course_overview_form, .topic_hierarchy_widget, .topic_information_widget, .chapter_addition_widget, .topic_addition_widget, .topic_schedule_widget {
...
<script>
    ...
    $(document).ready(function () {
        ...
        if ('${params.loadPedagogyTab}' == 'true') {
...
<div id="help_placeholder">
    ...
    <div id="qtipPlace" style="float: right;
    text-align: right;
    position: absolute;
    background-color: #FFFF5A;
    padding-right:1px;
    ...
    <div id="tabs">
        <ul>
            ...
            <li><a href="#tabs-4"><img class="tab_icon" src="${resource(dir: 'images', file: 'assess_icon.png')}"
              ...
              <li><a href="${createLink(controller: 'pedagogy', action: 'pedagogyTab', id: imodInstance?.id, params: [objectiveId: params.objectiveId])}">
              		<img class="tab_icon" src="${resource(dir: 'images', file: 'pedagogy_icon.png')}"
                            ...
                            <tr height="50px">
                                ...
                                <td>
                                    <fieldset class="buttons">
                                        <g:actionSubmit class="save showHoverNew" action="update"  title="${Help.toolTip("OVERVIEW", "Save Course Overview")}"
                                                        value="${message(code: 'Save', default: 'Save')}"/>
                                        <g:actionSubmit class="delete showHoverNew" action="delete"
        ...
        <div id="tabs-5"  style = "height: content">
            %{--<g:render template="/pedagogy/pedagogyMainTemplate"/>--}%
        </div>
    </div>
</div>
</body>
