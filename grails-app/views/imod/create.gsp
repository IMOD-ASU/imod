...
<html>
	...
	<body onLoad="myFunc()">
		<a href="#create-imod" class="skip" tabindex="-1">
									...
									<tr height="50px">
										...
										<td>
											<fieldset class="buttons">
												<g:submitButton name="create" class="save showHoverNew" title="${Help.toolTip("OVERVIEW", "Save Course Overview")}" value="${message(code: 'default.button.create.label', default: 'Create Course Overview')}" />
											</fieldset>
										</td>
									</tr>
									<tr>
