...
<div id="topicDialogBackground" class="modalBackground">
</div>
<div id="topicDialog">
	...
	<fieldset class="buttons topicButtonField">
		<span class="topicButtonGradient">
			<g:actionSubmit 
				class="add showHoverNew topicButton" 
				action="add" 
				id="addTopic"
		...
		<span class="topicButtonGradient">
			<g:actionSubmit 
				class="remove showHoverNew topicButton" 
				action="remove"
				id="removeTopic" 
	...
	<fieldset id="topicModalClose" class="buttons topicButtonField">
		<span class="topicButtonGradient saveBG">
			<button 
				...
				</i>${message(code: 'Save Topic', default: ' Finish')}
			</button>
		</span>
		<span class="topicButtonGradient cancelBG">
			<button 
				...
				<i class="fa fa-times"></i>${message(code: 'Cancel Topics', default: ' Cancel')}
			</button>
		</span>
	</fieldset>
</div>
