...
<html>
	...
	<body>
		<a href="#list-instructorPhone" class="skip" tabindex="-1">
				...
				<tbody>
					<g:each in="${instructorPhoneInstanceList}" status="i" var="instructorPhoneInstance">
						<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
							<td>
								<g:link action="show" id="${instructorPhoneInstance.id}">
									${fieldValue(bean: instructorPhoneInstance, field: "instructor")}
								</g:link>
							</td>
							<td>
								${fieldValue(bean: instructorPhoneInstance, field: "number")}
							</td>
							<td>
								${fieldValue(bean: instructorPhoneInstance, field: "type")}
							</td>
						</tr>
					</g:each>
				</tbody>
