...
<html>
	...
	<body>
		<a href="#show-contentResourceType" class="skip" tabindex="-1">
		...
		<div id="show-contentResourceType" class="content scaffold-show" role="main">
				...
				<g:if test="${contentResourceTypeInstance?.description}">
					<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="description-label">
							<g:fieldValue bean="${contentResourceTypeInstance}" field="description"/>
						</span>
					</li>
				</g:if>
			</ol>
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${contentResourceTypeInstance?.id}">
