...
<html>
	...
	<body>
		<a href="#list-scheduleRepeats" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-scheduleRepeats" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${scheduleRepeatsInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
