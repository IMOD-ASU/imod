...
<html>
	...
	<body>
		<a href="#list-courseComponentCode" class="skip" tabindex="-1">
				...
				<tbody>
					<g:each in="${courseComponentCodeInstanceList}" status="i" var="courseComponentCodeInstance">
						<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
							<td>
								<g:link action="show" id="${courseComponentCodeInstance.id}">
									${fieldValue(bean: courseComponentCodeInstance, field: "description")}
								</g:link>
							</td>
							<td>
								${fieldValue(bean: courseComponentCodeInstance, field: "designation")}
							</td>
						</tr>
					</g:each>
				</tbody>
