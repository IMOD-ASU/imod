...
<html>
	...
	<body>
		<a href="#list-instructor" class="skip" tabindex="-1">
			...
			<table>
				...
				<g:each in="${instructorInstanceList}" status="i" var="instructorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						<td>
							<g:link action="show" id="${instructorInstance.id}">
								${fieldValue(bean: instructorInstance, field: "lastName")}
							</g:link>
						</td>
						<td>
							${fieldValue(bean: instructorInstance, field: "firstName")}
						</td>
						<td>
							${fieldValue(bean: instructorInstance, field: "location")}
						</td>
						<td>
							${fieldValue(bean: instructorInstance, field: "email")}
						</td>
						<td>
							${fieldValue(bean: instructorInstance, field: "officeHours")}
						</td>
						<td>
							${fieldValue(bean: instructorInstance, field: "webPage")}
						</td>
					</tr>
				</g:each>
				</tbody>
