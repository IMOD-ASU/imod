...
<html>
	...
	<body>
		<a href="#show-coursePolicy" class="skip" tabindex="-1">
		...
		<div id="show-coursePolicy" class="content scaffold-show" role="main">
				...
				<g:if test="${coursePolicyInstance?.category}">
					<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="category-label">
							<g:link controller="coursePolicyCategory" action="show" id="${coursePolicyInstance?.category?.id}">
								${coursePolicyInstance?.category?.encodeAsHTML()}
							</g:link>
						</span>
					</li>
				</g:if>
				<g:if test="${coursePolicyInstance?.description}">
					<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="description-label">
							<g:fieldValue bean="${coursePolicyInstance}" field="description"/>
						</span>
					</li>
				</g:if>
				...
				<g:if test="${coursePolicyInstance?.name}">
					<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="name-label">
							<g:fieldValue bean="${coursePolicyInstance}" field="name"/>
						</span>
					</li>
				</g:if>
				...
				<g:if test="${coursePolicyInstance?.user}">
					<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="user-label">
							<g:link controller="imodUser" action="show" id="${coursePolicyInstance?.user?.id}">
								${coursePolicyInstance?.user?.encodeAsHTML()}
							</g:link>
						</span>
					</li>
				</g:if>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${coursePolicyInstance?.id}">
