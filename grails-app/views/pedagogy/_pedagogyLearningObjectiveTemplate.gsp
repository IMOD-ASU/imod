    ...
    <tr>
        <td style="padding-right: 0;">
            <div class="chapter_addition_widget" style="width: 310px; min-height: 654px;margin-right:10px;">
                ...
                <div >
                    <div style="margin-top: 20px; height: 320px; overflow:scroll; overflow-x: hidden;" id="chapterListTable"><p>
                        <ul style="margin-left: 10px;" id="chapterListUL">
                            <g:if test="${objectiveList}">
                                <g:each in="${objectiveList}"
                                        var="chapter"
                                        status="count">
                                    <g:render template="/pedagogy/chapterListTableTemplate"
                ...
                <div class="form_title removeBorder"><span class="title_text"><g:message
                    ...
                    <span style="float: right;padding-right: 7px;" class="title_text">
                    	<a href="javascript:" style="text-decoration:none;color:#FFFFFF" onclick="submitRefresh();" title="${Help.toolTip("PEDAGOGY", "Refresh")}" class="showHover">Refresh</a>
                    	%{--<button id="createChapter" class="add showHover"
                                                       title="${Help.toolTip("CONTENT", "Add Filter options")}"
                                                       onclick="showObjective()"><g:message
                                code="chapter.addition.widget.add.button"/></button>
                        <button id="deleteChapter" class="remove showHover" onclick="removeAllObjective()"
                                title="${Help.toolTip("CONTENT", "Remove Filter options")}">
                            <g:message code="learning.objectives..widget.remove.button"/></button>--}%
                    </span></div>
