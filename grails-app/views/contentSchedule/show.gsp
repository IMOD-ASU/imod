...
<html>
	...
	<body>
		<a href="#show-contentSchedule" class="skip" tabindex="-1">
		...
		<div id="show-contentSchedule" class="content scaffold-show" role="main">
				...
				<g:if test="${contentScheduleInstance?.content}">
					<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="content-label">
							<g:link controller="content" action="show" id="${contentScheduleInstance?.content?.id}">
								${contentScheduleInstance?.content?.encodeAsHTML()}
							</g:link>
						</span>
					</li>
				</g:if>
				...
				<g:if test="${contentScheduleInstance?.imod}">
					<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="imod-label">
							<g:link controller="imod" action="show" id="${contentScheduleInstance?.imod?.id}">
								${contentScheduleInstance?.imod?.encodeAsHTML()}
							</g:link>
						</span>
					</li>
				</g:if>
				...
				<g:if test="${contentScheduleInstance?.startDate}">
					<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="startDate-label">
							<g:formatDate date="${contentScheduleInstance?.startDate}" />
						</span>
					</li>
				</g:if>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${contentScheduleInstance?.id}">
