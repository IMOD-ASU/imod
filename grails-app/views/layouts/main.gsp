...
<div id="imodlogo" role="banner" style="background-color:#0C1625;"><a href="${createLink(uri: '/')}"><img id="imod_logo"
    ...
    <span id='s2ui_login_link_container'>
        ...
        <a class="banner-home" href="${createLink(uri: '/')}"><img class="resize_home"
                                                                   src="${resource(dir: 'images', file: 'home_sm.png')}"
                                                                   alt=""/><g:message code="default.home.label"/></a>
        <nobr>
...
<g:layoutBody/>
<div class="footer" role="contentinfo">Copyright &copy; 2014 IMOD&trade;</div>
