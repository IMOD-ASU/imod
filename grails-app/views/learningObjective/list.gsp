...
<html>
	...
	<body>
		<a href="#list-learningObjective" class="skip" tabindex="-1">
				...
				<tbody>
					<g:each in="${learningObjectiveInstanceList}" status="i" var="learningObjectiveInstance">
						<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
							<td>
								<g:link action="show" id="${learningObjectiveInstance.id}">
									${fieldValue(bean: learningObjectiveInstance, field: "actionWord")}
								</g:link>
							</td>
							<td>
								${fieldValue(bean: learningObjectiveInstance, field: "completeLearningObjective")}
							</td>
							<td>
								${fieldValue(bean: learningObjectiveInstance, field: "condition")}
							</td>
							<td>
								${fieldValue(bean: learningObjectiveInstance, field: "content")}
							</td>
							<td>
								${fieldValue(bean: learningObjectiveInstance, field: "criteria")}
							</td>
							<td>
								${fieldValue(bean: learningObjectiveInstance, field: "criteriaType")}
							</td>
						</tr>
					</g:each>
				</tbody>
