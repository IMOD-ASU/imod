...
<html>
	...
	<body>
		<a href="#show-contentResource" class="skip" tabindex="-1">
		...
		<div id="show-contentResource" class="content scaffold-show" role="main">
				...
				<g:if test="${contentResourceInstance?.name}">
					<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="name-label">
							<g:fieldValue bean="${contentResourceInstance}" field="name"/>
						</span>
					</li>
				</g:if>
				...
				<g:if test="${contentResourceInstance?.type}">
					<li class="fieldcontain">
						...
						<span class="property-value" aria-labelledby="type-label">
							<g:link controller="contentResourceType" action="show" id="${contentResourceInstance?.type?.id}">
								${contentResourceInstance?.type?.encodeAsHTML()}
							</g:link>
						</span>
					</li>
				</g:if>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${contentResourceInstance?.id}">
