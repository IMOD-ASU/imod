...
<html>
	...
	<body>
		<a href="#list-contentResource" class="skip" tabindex="-1">
		...
		<div id="list-contentResource" class="content scaffold-list" role="main">
			<h1>
				<g:message code="default.list.label" args="[entityName]" />
			</h1>
				...
				<tbody>
					<g:each in="${contentResourceInstanceList}" status="i" var="contentResourceInstance">
						<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
							<td>
								<g:link action="show" id="${contentResourceInstance.id}">
									${fieldValue(bean: contentResourceInstance, field: "name")}
								</g:link>
							</td>
							<td>
								${fieldValue(bean: contentResourceInstance, field: "type")}
							</td>
						</tr>
					</g:each>
				</tbody>
			...
			<div class="pagination">
				<g:paginate total="${contentResourceInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
