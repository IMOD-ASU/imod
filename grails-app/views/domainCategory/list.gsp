...
<html>
	...
	<body>
		<a href="#list-domainCategory" class="skip" tabindex="-1">
			...
			<table>
				...
				<g:each in="${domainCategoryInstanceList}" status="i" var="domainCategoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						<td>
							<g:link action="show" id="${domainCategoryInstance.id}">
								${fieldValue(bean: domainCategoryInstance, field: "domain")}
							</g:link>
						</td>
						<td>
							${fieldValue(bean: domainCategoryInstance, field: "name")}
						</td>
					</tr>
				</g:each>
				</tbody>
