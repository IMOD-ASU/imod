...
class ContentController {
    ...
    def contentTab(Long id) {
        ...
        if (imod) {
            ...
            render template: '/content/contentTab', model: [topicDateForCurrentLearningObjectiveList: topicDateForCurrentLearningObjectiveList,
                    learningObjectiveDates: learningObjectiveDates, remainingContent: remainingContent, imod: imod,
                    currentImodContentList: currentImodContentList,
                    currentChapterContentList: contentList, chapter: objective,
